...
function Header() {
  ...
  const { linkdein, github, gitlab } = socialMediaUrl;
  const toggleClass = () => {
    setIsOpen(!isOpen);
  };
    ...
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      ...
      >
        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          <li>
            <a href={gitlab} target="_blank" rel="noreferrer noopener">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M128 236l47.37-145.83H80.63L128 236z" fill="#E24329" />
                <path d="M128 236L80.63 90.17H9.28L128 236z" fill="#FC6D26" />
                <path
                  d="M9.28 90.17L0 118.64c-1.71 5.27.16 11.08 4.66 14.44L128 236 9.28 90.17z"
                  fill="#FCA326"
                />
                <path
                  d="M9.28 90.17h71.35L56.07 18.63c-1.98-6.09-10.62-6.09-12.6 0L9.28 90.17z"
                  fill="#E24329"
                />
                <path d="M128 236l47.37-145.83h71.35L128 236z" fill="#FC6D26" />
                <path
                  d="M246.72 90.17l9.28 28.47c1.71 5.27-.16 11.08-4.66 14.44L128 236l118.72-145.83z"
                  fill="#FCA326"
                />
                <path
                  d="M246.72 90.17h-71.35l24.56-71.54c1.98-6.09 10.62-6.09 12.6 0l34.19 71.54z"
                  fill="#E24329"
                />
              </svg>
            </a>
